...
internal sealed class BasicLoader
{
    ...
    public void LoadTexture(byte[] textureData, uint width, uint height, out D3D11Texture2D texture, out D3D11ShaderResourceView textureView)
    {
        this.CreateTexture(textureData, width, height, out texture, out textureView);
    }
    ...
    {
        D3D11Texture2DDesc textureDesc = new(DxgiFormat.B8G8R8A8UNorm, width, height, 1, 1);
        ...
        try
        {
            D3D11ShaderResourceViewDesc textureViewDesc = new()
            {
